...
inline void log_info(char *msg) { printf("\033[1;34m===\033[0m %s\n", msg); }

inline void log_warn(char *msg) { fprintf(stderr, "\033[1;33m=!=\033[0m %s\n", msg); }

inline void log_err(char *msg) { fprintf(stderr, "\033[31m!!!\033[0m %s\n", msg); }

inline void log_fatal(char *msg)
{
